...
--
-- Host: localhost
-- Generation Time: Nov 19, 2024 at 04:10 PM
...
VALUES (
        ...
        'doctor',
        'doctor@gmail.com',
        '$2y$10$8AcRbtS8.dla0Jvtg1KJGOUn3dRSOvHmPG387azTsF41FX5kw5yXO'
    ),
    (
        3,
        'ajf',
...
VALUES (
        ...
        'riad535',
        'riad1234@gmail.com',
        '$2y$10$Kd5ykwrCfU6VIoS/0M5uEey9LgE8331ff8nwAYMnKHk2VLD678OD.',
        'A+'
    );
...
VALUES (
        ...
        'metul123',
        'metul1234@gmail.com',
        '$2y$10$CKRsoSpPcEk7kGBNVNP7xuND9FhVLqLDdkEGCxkqO3uoghC5zz9Ha',
        'B+'
    );
...
--
ALTER TABLE `blood` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `donor` ADD PRIMARY KEY (`id`);
